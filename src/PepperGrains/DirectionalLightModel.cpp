...
void DirectionalLightModel::SharedResources::render(const Renderable::RenderPass& rendPass, const glm::mat4& modelMat, const glm::vec3& lightColor) {
...
void DirectionalLightModel::render(const Renderable::RenderPass& rendPass, const glm::mat4& modelMat) {
