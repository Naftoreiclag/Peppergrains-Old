...
void DesignerGameLayer::loadGBuffer() {
...
void DesignerGameLayer::unloadGBuffer() {
...
void DesignerGameLayer::loadSun() {
...
void DesignerGameLayer::unloadSun() {
    glDeleteTextures(4, mSky.sunDepthTextures);
    glDeleteFramebuffers(4, mSky.sunFramebuffers);
    mSky.sunModel->drop();
}

void DesignerGameLayer::renderFrame(glm::vec4 debugShow, bool wireframe) {
